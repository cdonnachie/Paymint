...
class _LockscreenViewState extends State<LockscreenView> {
  ...
  _checkUseBiometrics() async {
    ...
    final bool useBiometrics = await wallet.get('use_biometrics') ?? false;
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('Please input PIN to unlock wallet',
            ...
            Padding(
              ...
              child: PinPut(
                ...
                followingFieldDecoration: _pinPutDecoration.copyWith(
                  ...
                  border:
                      Border.all(width: 1.5, color: Colors.lightBlue.shade700),
                ),
              ),
            ),
            SizedBox(height: 40),
